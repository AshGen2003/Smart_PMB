...
<p align="center">
  A digital platform for paddy purchasing, warehouse operations, transportation, milling, and farmer services in Sri Lanka.<br/>
  Replaces manual, paper-based purchasing records with a role-based web system connecting farmers, drivers, mill owners, PMB officers, and administrators.
</p>
...
| **Mill Owner** | Self-registration, license applications, milling report submission and tracking. |
| **Authorized Purchaser** | Records rice purchase requests against warehouse stock. |
| **PMB Officer** | Warehouse management, paddy type/pricing management, the harvest approval workflow (pending → verified → collected/rejected, with automatic payment records), fleet/route/delivery management, mill license approvals, rice request approvals, and downloadable stock/transaction reports (PDF). |
...
| **Mill Owner** | none — self-service only (own license applications, milling reports). |
| **Warehouse Manager · Authorized Purchaser · Moderator** | Subsets of the officer permissions above, assignable per-role. |
