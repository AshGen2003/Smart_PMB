 ...
 * reports page: a governance-focused summary (security activity, audit
 * log, backups) plus a link to download the same report as a PDF via the
 * /api/reports/admin-pdf route handler.
 *
