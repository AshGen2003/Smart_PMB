...
import { History, LayoutDashboard, MessageSquare, QrCode, Settings, ChevronLeft, ChevronRight, User, Truck } from "lucide-react";
...
const NAV_ITEMS = [
  ...
  { label: "Deliveries", href: "/warehouse-manager/deliveries", icon: Truck, permission: "view_dashboard" },
