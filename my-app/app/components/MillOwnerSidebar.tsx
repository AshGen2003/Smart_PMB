/**
 * Collapsible left navigation for the mill owner portal, mirroring
 * FarmerSidebar.tsx: a fixed nav list (no permission-based filtering) since
 * every mill owner sees the same links.
 */
"use client";
...
export default function MillOwnerSidebar() {
