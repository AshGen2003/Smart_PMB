...
export const PREVIEW_HARVESTS = [
  {
    ...
    impurity_percent: "3.00",
    empty_grains_percent: "2.00",
    meets_pmb_quality_standard: true,
    quality_check: true,
    unit_price: "120.00",
  ...
  },
  {
    ...
    empty_grains_percent: null,
    meets_pmb_quality_standard: null,
    quality_check: null,
    unit_price: null,
  ...
  },
  {
    ...
    impurity_percent: "10.50",
    empty_grains_percent: "4.00",
    meets_pmb_quality_standard: false,
    quality_check: true,
    unit_price: "120.00",
  ...
  deliveries: [
    {
      ...
      dispatch_manifest: null,
      milling_return_request: null,
      rice_request: null,
      milling_allocation: null,
      linked_request_label: null,
