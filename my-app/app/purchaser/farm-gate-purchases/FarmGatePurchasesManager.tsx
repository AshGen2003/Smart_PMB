...
export default function FarmGatePurchasesManager({
  ...
  const [withdrawTarget, setWithdrawTarget] = useState<DispatchManifestRow | null>(null);
  ...
  function confirmWithdraw() {
    ...
    startTransition(async () => {
      const result = await withdrawDispatchManifest(target.id);
  ...
  return (
    <div className={styles.page}>
      ...
      {withdrawTarget && (
        <ConfirmModal
          title="Withdraw this dispatch manifest?"
