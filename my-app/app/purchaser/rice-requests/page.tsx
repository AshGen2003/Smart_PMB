/**
 * `/purchaser/rice-requests` — full rice request history for the logged-in
 * Authorized Purchaser, plus a form to submit a new request and a withdraw
 * action while it's still pending. Mirrors mill-owner/licenses/page.tsx
 * (the mill-owner equivalent self-service page).
 */
...
export default async function PurchaserRiceRequestsPage() {
