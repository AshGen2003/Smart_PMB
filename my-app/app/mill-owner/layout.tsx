/**
 * Layout for the mill owner portal: dashboard, licenses, milling reports,
 * messages, settings. Every page under `app/mill-owner/` is rendered as
 ...
 * legitimate cases that should NOT be gated: an admin-created mill-owner
