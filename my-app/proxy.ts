...
const PUBLIC_PREFIXES = ["/login", "/signup", "/confirm-email", "/forgot-password", "/pmb-officer", "/transparency", "/api/pmb", "/api/officers", "/api/warehouses", "/api/purchases", "/api/paddy-types"];
